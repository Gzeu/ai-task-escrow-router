...
// Core types
#[derive(TypeAbi, PartialEq, Eq, Debug, TopEncode, TopDecode, NestedEncode, NestedDecode, Clone, Copy)]
pub enum TaskState {
    Open,
    Accepted,
    Submitted,
...
#[derive(TypeAbi, TopEncode, TopDecode, NestedEncode, NestedDecode, Clone, Debug)]
