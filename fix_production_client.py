...
# Fixed production-client.ts without duplicate exports
production_client_content = '''/**
...
with open(f"{base}/production-client.ts", "w", encoding='utf-8') as f:
    f.write(production_client_content)

print("✅ Fixed Production Client!")
