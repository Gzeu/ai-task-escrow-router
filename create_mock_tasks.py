...
base = "e:/tik/apps/web/src/pages"

# Create a simple working tasks page with correct types
tasks_content = '''import React, { useState, useEffect } from 'react';
...
# Write the fixed tasks page
with open(f"{base}/tasks.tsx", "w", encoding='utf-8') as f:
    f.write(tasks_content)

print("✅ Created working tasks page!")
