...
# Fixed enterprise-client.ts without duplicate exports
enterprise_client_content = '''/**
...
with open(f"{base}/enterprise-client.ts", "w", encoding='utf-8') as f:
    f.write(enterprise_client_content)

print("✅ Fixed Enterprise Client!")
